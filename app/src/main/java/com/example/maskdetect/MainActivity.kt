package com.example.maskdetect
...
import com.example.maskdetect.ml.FackMaskDetection
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupML() {
        val options: org.tensorflow.lite.support.model.Model.Options =
            org.tensorflow.lite.support.model.Model.Options.Builder()
                .setDevice(org.tensorflow.lite.support.model.Model.Device.GPU).setNumThreads(5)
                .build()
